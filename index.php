        ...
        <div class="top-categories-search btn-radius">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <button class="btn secondry-bg-color btn-radius" type="button" onclick="filter_category_cards()" ><i class="icofont icofont-search-alt-2"></i> Search</button>
            </span>
          </div>
        </div>
      </div>
        ...
        <?PHP  if(isset($_SESSION['login'])){ ?>
          ...
          <?PHP }else{ ?>
            <li class="nav-item Dashboard">
              <a class="nav-link" href="seller_dashboard/index.php">Dashboard</a>
            </li>
        <?PHP } 
  ...
  <nav id="sidebar">
    ...
    <ul class="list-unstyled components">
      ...
      <?PHP  if(isset($_SESSION['login'])){ ?>
          ...
          <?PHP }else{ ?>
            <li class="nav-item Dashboard">
              <a class="nav-link side_nav_dismiss" href="seller_dashboard/index.php">Dashboard</a>
            </li>
        <?PHP } 
        if (!isset($_SESSION['cs'])){?>
          <li class="nav-item ActAsCourierServices">
